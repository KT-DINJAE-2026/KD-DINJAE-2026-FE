...
정류장 QR을 찍은 뒤 도착 정류장을 입력하면, 두 정류장 사이를 운행하는 버스의 도착시간과 입석 부담을 비교하는 React 프로토타입입니다.
...
4. 버스별 도착시간, 총 이동시간, 예상 입석 부담을 비교합니다.
5. 상세 화면에서 정류장 구간별 `여유·보통·혼잡` 예측을 확인합니다.
6. 입석 부담이 큰 버스에는 추가 시간과 부담 감소량을 함께 보여주고 다른 버스를 비교할 수 있게 안내합니다.
...
- `보문역 2번 출구 정류장`: 혼잡도 예측이 있는 1112번과 95번 비교
- `서울시청 앞 정류장`: 과거 데이터가 부족해 빠른 도착만 제공
