...
| `05-detail-fast.svg` | 95번의 구간별 예상과 1112번 대안 안내 |
| `05-detail-unavailable.svg` | 혼잡도 데이터 없이 도착 정보만 제공하는 상세 |
...
04-compare-fast
  ...
  95번 → 05-detail-fast
05-detail-fast
  1112번과 비교하기 → 04-compare
04-compare-unavailable
  혼잡도 비교는 비활성화
  101번 → 05-detail-unavailable
...
- 환승이나 추가 도보가 필요한 우회 경로는 접근성 정보가 준비되기 전까지 추천하지 않습니다.
