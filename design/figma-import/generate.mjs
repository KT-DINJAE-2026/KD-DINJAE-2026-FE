...
const screens = [
  ...
  },
  {
    ...
    svg: screen("입석 부담과 빠른 도착 버스 비교 화면", [
      ...
      rect(24, 184, 342, 66, C.blueSoft, 8),
      icon("info", 42, 203, 20, C.blue),
      multiline(74, 206, ["1112번은 5분 늦지만", "입석 부담 예상 시간이 약 7분 짧아요."], 14, 700, C.subtext, 1.45),
      routeCard(270, {
        route: "1112번",
      ...
      rect(24, 620, 342, 56, C.page, 8),
      icon("clock", 42, 638, 20, C.subtext),
      text(74, 648, "예측 기준 · 평일 오후 2시 승하차 패턴", 13, 600, C.subtext),
  ...
  },
  {
    ...
    svg: screen("혼잡도 데이터가 부족한 버스 비교 화면", [
      ...
      text(24, 108, "어떤 버스가", 29, 800),
      text(24, 146, "더 나을까요?", 29, 800),
      rect(24, 184, 342, 84, C.amberSoft, 8),
      icon("alert", 42, 214, 20, C.amber, 2),
      multiline(74, 202, ["아직 데이터가 부족해", "혼잡도는 예측하기 어려워요.", "빠른 도착순으로 보여드릴게요."], 14, 700, C.subtext, 1.45),
      fastRouteCard(284, {
        route: "101번",
        meta: "종로·시청 방면 · 저상버스",
        badge: "빠른 도착",
      ...
      rect(24, 616, 342, 56, C.page, 8),
      icon("refresh", 42, 634, 20, C.subtext),
      text(74, 644, "혼잡도 데이터가 생기면 자동으로 갱신해요.", 13, 600, C.subtext),
...
<svg xmlns="http://www.w3.org/2000/svg" width="1440" height="760" viewBox="0 0 1440 760" role="img" aria-label="사용자 흐름도">
  ...
  ${flowCard(850, 236, "4", "구간별 상세", "예측 근거·대안 확인", C.green)}
  ...
  ${text(878, 510, "대안 안내 원칙", 15, 800, C.blue)}
  ${multiline(878, 548, ["부담 감소와 추가 시간을", "함께 보여준 뒤 재비교"], 14, 600, C.subtext, 1.55)}
