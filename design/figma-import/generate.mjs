...
const screens = [
  ...
  },
  {
    ...
    svg: screen("버스 구간별 혼잡도 상세 화면", [
      ...
      rect(24, 316, 342, 88, C.page, 8),
      metric(40, 337, "버스 도착", "5분 후"),
      metric(142, 337, "목적지까지", "약 20분"),
      metric(246, 337, "앉기 편한 시간", "약 12분", C.green),
      text(24, 438, "구간별 예상", 21, 700, C.subtext),
      line(42, 470, 42, 660, C.border, 3),
      circle(42, 478, 8, C.amber),
      text(64, 468, "성북구청 → 성북소방서", 18, 700),
      text(64, 496, "3분 · 입석 이동 가능", 16, 600, C.amber),
      rect(300, 484, 66, 34, C.amberSoft, 6),
      text(333, 501, "보통", 14, 800, C.amber, { anchor: "middle" }),
      circle(42, 558, 8, C.green),
      text(64, 548, "성북소방서 → 성북경찰서", 18, 700),
      text(64, 576, "4분 · 좌석 이용 여건 개선 예상", 16, 600, C.green),
      rect(300, 564, 66, 34, C.greenSoft, 6),
      text(333, 581, "여유", 14, 800, C.green, { anchor: "middle" }),
      circle(42, 638, 8, C.green),
      text(64, 628, "성북경찰서 → 보문역 2번 출구", 18, 700),
      text(64, 656, "8분 · 여유 단계 유지 예상", 16, 600, C.green),
      rect(300, 644, 66, 34, C.greenSoft, 6),
      text(333, 661, "여유", 14, 800, C.green, { anchor: "middle" }),
      rect(24, 686, 342, 72, C.blueSoft, 8),
      icon("info", 42, 709, 22, C.blue),
      multiline(78, 706, ["앉기 편한 시간은 여유 예상 구간의 합계이며", "좌석을 보장하지는 않아요."], 14, 600, C.subtext, 1.45),
      text(195, 808, "버스 비교로 돌아가기", 18, 800, C.blue, { anchor: "middle" }),
    ].join("\n")),
  },
  {
    ...
    svg: screen("빠른 도착 버스의 구간별 혼잡도 화면", [
      ...
      rect(24, 316, 342, 88, C.page, 8),
      metric(40, 337, "버스 도착", "3분 후"),
      metric(142, 337, "목적지까지", "약 15분"),
      metric(246, 337, "앉기 편한 시간", "약 2분", C.green),
      text(24, 438, "구간별 예상", 21, 700, C.subtext),
      line(42, 470, 42, 660, C.border, 3),
      circle(42, 478, 8, C.red),
      text(64, 468, "성북구청 → 성북소방서", 18, 700),
      text(64, 496, "4분 · 신체 접촉이 발생할 수 있음", 16, 600, C.red),
      rect(300, 484, 66, 34, C.redSoft, 6),
      text(333, 501, "혼잡", 14, 800, C.red, { anchor: "middle" }),
      circle(42, 558, 8, C.amber),
      text(64, 548, "성북소방서 → 성북경찰서", 18, 700),
      text(64, 576, "6분 · 입석 이동 가능", 16, 600, C.amber),
      rect(300, 564, 66, 34, C.amberSoft, 6),
      text(333, 581, "보통", 14, 800, C.amber, { anchor: "middle" }),
      circle(42, 638, 8, C.green),
      text(64, 628, "성북경찰서 → 보문역 2번 출구", 18, 700),
      text(64, 656, "2분 · 좌석 이용 여건 개선 예상", 16, 600, C.green),
      rect(300, 644, 66, 34, C.greenSoft, 6),
      text(333, 661, "여유", 14, 800, C.green, { anchor: "middle" }),
      rect(24, 686, 342, 72, C.amberSoft, 8),
      icon("alert", 42, 709, 22, C.amber, 2),
      multiline(78, 706, ["앉기 편한 시간은 여유 예상 구간만 더한 값이며", "혼잡 구간에서는 좌석 이용이 어려울 수 있어요."], 14, 600, C.subtext, 1.45),
      text(195, 808, "버스 비교로 돌아가기", 18, 800, C.blue, { anchor: "middle" }),
    ].join("\n")),
  },
  {
  ...
  },
  {
    ...
    svg: screen("혼잡도 데이터가 부족한 버스 상세 화면", [
      ...
      rect(24, 316, 342, 88, C.page, 8),
      metric(40, 337, "버스 도착", "4분 후", C.blue),
      metric(142, 337, "목적지까지", "약 22분"),
      metric(246, 337, "좌석 정보", "확인 어려움", C.muted),
      rect(24, 434, 342, 116, C.amberSoft, 8),
      icon("alert", 42, 468, 22, C.amber, 2),
      multiline(78, 454, ["아직 데이터가 부족해", "구간별 앉기 편한 시간은", "보여드리기 어려워요."], 16, 700, C.subtext, 1.5),
      text(195, 604, "다른 도착 버스 보기", 18, 800, C.blue, { anchor: "middle" }),
      text(195, 804, "도착 정보는 실제 운행 상황에 따라 달라질 수 있어요.", 13, 500, C.muted, { anchor: "middle" }),
    ].join("\n")),
  },
];
